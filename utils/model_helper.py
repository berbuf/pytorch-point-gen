    ...
    def __init__(self, param, net, optimizerList, checkpoint_manager, helperList=None):
        ...
        if args.restore is not None:
            ...
            self.net.load_state_dict(
                checkpoint['weights'], param.volatile.load_exclude_set)
            ...
            logging.info("loaded checkpoint at %d epochs, %d batches",
                         self.now_epoch, self.now_batch)
        ...
        for key, v in args.items():
            if isinstance(v, AnnealParameter):
                if v[0] == "set":
                    ...
                    self.anneal_list.append(
                        AnnealHelper(self, key, 0, 0, **v[1]))
